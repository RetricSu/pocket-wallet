    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-8">
      ...
      <div className="bg-bg-secondary/30 rounded-lg p-6 border border-border/20">
        ...
        <div className="text-text-secondary text-sm">
          <p>
            Pocket Wallet use CKB Light Client to sync the blockchain right in your browser without relying on any
            centralized RPC service. By integrating Nostr with Nip46 and more, Pocket Wallet provides a fully verifiable
            wallet experience in the methodology of client-side-validation and POW verifications.
          </p>
        </div>
      </div>
